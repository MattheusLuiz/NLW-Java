...
import com.rocketseat.certification_nlw.modules.students.entities.AsnwersCertificationsEntity;
...
public class StudentCertificationAnswersUseCase {
    ...
    public CertificationStudentEntity execute(StudentCertificationAnswerDTO dto) throws Exception {
        ...
        List<AsnwersCertificationsEntity> answersCertifications = new ArrayList<>();
        ...
        dto.getQuestionsAnswers().stream().forEach(questionAnswer -> {
            ...
            var asnwersCertificationsEntity = AsnwersCertificationsEntity.builder()
            .answerID(questionAnswer.getAlternativeID())
            .questionID(questionAnswer.getQuestionID())
            .isCorrect(questionAnswer.isCorrect()).build();

            answersCertifications.add(asnwersCertificationsEntity);
        });
        ...
        certificationStudentEntity.setAsnwersCertificationsEntities(answersCertifications);
